proc create_design { design_name } {
    ...
    assign_bd_address -offset 0x0 -range 0x80000000 -target_address_space [get_bd_addr_spaces xs_top/peripheral_0] [get_bd_addr_segs m_axi_io/Reg] -force
