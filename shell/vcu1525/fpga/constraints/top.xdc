...
set_property -dict {LOC AM11 } [get_ports pcie_ep_gt_ref_clk_clk_p[0]] ;
set_property -dict {LOC AM10 } [get_ports pcie_ep_gt_ref_clk_clk_n[0]] ;
...
set_property PACKAGE_PIN AY38       [get_ports ddr4_mig_sys_clk_clk_n]
set_property PACKAGE_PIN AY37       [get_ports ddr4_mig_sys_clk_clk_p]

# PCIe EP perstn physical location
set_property PACKAGE_PIN BD21 [get_ports pcie_ep_perstn]
set_property IOSTANDARD LVCMOS12 [get_ports pcie_ep_perstn]

# LED
set_property PACKAGE_PIN BC21 [get_ports ddr4_mig_calib_done]
set_property IOSTANDARD LVCMOS12 [get_ports ddr4_mig_calib_done]

set_property PACKAGE_PIN BB21 [get_ports pcie_ep_phy_ready]
set_property IOSTANDARD LVCMOS12 [get_ports pcie_ep_phy_ready]

set_property PACKAGE_PIN BA20 [get_ports pcie_ep_lnk_up]
set_property IOSTANDARD LVCMOS12 [get_ports pcie_ep_lnk_up]
