...
set_property PACKAGE_PIN AU17 [get_ports pcie_rp_j9_perstn]
set_property IOSTANDARD LVCMOS33 [get_ports pcie_rp_j9_perstn]

# PCIe RP ETH perstn physical location
set_property PACKAGE_PIN BB17 [get_ports pcie_rp_j6_perstn]
set_property IOSTANDARD LVCMOS33 [get_ports pcie_rp_j6_perstn]
