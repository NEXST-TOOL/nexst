...
connect_bd_intf_net -intf_net [get_bd_intf_nets xdma_rp_M_AXI_B] [get_bd_intf_pins system_ila_0/SLOT_0_AXI] [get_bd_intf_pins xdma_rp/M_AXI_B]
  ...
  connect_bd_net -net xdma_ep_axi_aclk [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dwidth_converter_0/s_axi_aclk] [get_bd_pins axi_ethernet_0/axis_clk] [get_bd_pins axi_ethernet_0/s_axi_lite_clk] [get_bd_pins axi_ic_bootrom/ACLK] [get_bd_pins axi_ic_bootrom/M00_ACLK] [get_bd_pins axi_ic_bootrom/S00_ACLK] [get_bd_pins axi_ic_bootrom/S01_ACLK] [get_bd_pins axi_ic_ddr_mem/ACLK] [get_bd_pins axi_ic_ddr_mem/S00_ACLK] [get_bd_pins axi_ic_ddr_mem/S01_ACLK] [get_bd_pins axi_ic_ep_bar_axi_lite/ACLK] [get_bd_pins axi_ic_ep_bar_axi_lite/M00_ACLK] [get_bd_pins axi_ic_ep_bar_axi_lite/M01_ACLK] [get_bd_pins axi_ic_ep_bar_axi_lite/M02_ACLK] [get_bd_pins axi_ic_ep_bar_axi_lite/M03_ACLK] [get_bd_pins axi_ic_ep_bar_axi_lite/S00_ACLK] [get_bd_pins axi_ic_pcie_rp_dma/ACLK] [get_bd_pins axi_ic_pcie_rp_dma/M00_ACLK] [get_bd_pins axi_ic_pcie_rp_dma/S01_ACLK] [get_bd_pins axi_ic_pcie_rp_mmio/ACLK] [get_bd_pins axi_ic_pcie_rp_mmio/S00_ACLK] [get_bd_pins axi_ic_role_io/ACLK] [get_bd_pins axi_ic_role_io/M00_ACLK] [get_bd_pins axi_ic_role_io/M01_ACLK] [get_bd_pins axi_ic_role_io/M02_ACLK] [get_bd_pins axi_ic_role_io/M03_ACLK] [get_bd_pins axi_ic_role_io/M04_ACLK] [get_bd_pins axi_ic_role_io/S00_ACLK] [get_bd_pins axi_mm_base_reg/s_axi_aclk] [get_bd_pins axi_net_interconnect/ACLK] [get_bd_pins axi_net_interconnect/M00_ACLK] [get_bd_pins axi_net_interconnect/S00_ACLK] [get_bd_pins axi_net_interconnect/S01_ACLK] [get_bd_pins axi_net_interconnect/S02_ACLK] [get_bd_pins bootrom_bram_ctrl/s_axi_aclk] [get_bd_pins host_uart/s_axi_aclk] [get_bd_pins led_counter/CLK] [get_bd_pins pcie_rp_role_sync_reset/slowest_sync_clk] [get_bd_pins role_uart/s_axi_aclk] [get_bd_pins system_ila/clk] [get_bd_pins u_role/aclk] [get_bd_pins xdma_ep/axi_aclk]
  connect_bd_net -net xdma_ep_axi_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dwidth_converter_0/s_axi_aresetn] [get_bd_pins axi_ethernet_0/s_axi_lite_resetn] [get_bd_pins axi_ic_bootrom/ARESETN] [get_bd_pins axi_ic_bootrom/M00_ARESETN] [get_bd_pins axi_ic_bootrom/S00_ARESETN] [get_bd_pins axi_ic_bootrom/S01_ARESETN] [get_bd_pins axi_ic_ddr_mem/ARESETN] [get_bd_pins axi_ic_ddr_mem/S00_ARESETN] [get_bd_pins axi_ic_ddr_mem/S01_ARESETN] [get_bd_pins axi_ic_ep_bar_axi_lite/ARESETN] [get_bd_pins axi_ic_ep_bar_axi_lite/M00_ARESETN] [get_bd_pins axi_ic_ep_bar_axi_lite/M01_ARESETN] [get_bd_pins axi_ic_ep_bar_axi_lite/M02_ARESETN] [get_bd_pins axi_ic_ep_bar_axi_lite/M03_ARESETN] [get_bd_pins axi_ic_ep_bar_axi_lite/S00_ARESETN] [get_bd_pins axi_ic_pcie_rp_dma/S01_ARESETN] [get_bd_pins axi_ic_role_io/ARESETN] [get_bd_pins axi_ic_role_io/M00_ARESETN] [get_bd_pins axi_ic_role_io/M01_ARESETN] [get_bd_pins axi_ic_role_io/M03_ARESETN] [get_bd_pins axi_ic_role_io/M04_ARESETN] [get_bd_pins axi_ic_role_io/S00_ARESETN] [get_bd_pins axi_mm_base_reg/s_axi_aresetn] [get_bd_pins axi_net_interconnect/ARESETN] [get_bd_pins axi_net_interconnect/M00_ARESETN] [get_bd_pins axi_net_interconnect/S00_ARESETN] [get_bd_pins axi_net_interconnect/S01_ARESETN] [get_bd_pins axi_net_interconnect/S02_ARESETN] [get_bd_pins bootrom_bram_ctrl/s_axi_aresetn] [get_bd_pins host_uart/s_axi_aresetn] [get_bd_pins role_uart/s_axi_aresetn] [get_bd_pins system_ila/resetn] [get_bd_pins u_role/aresetn] [get_bd_pins xdma_ep/axi_aresetn]
