...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_role_interconnect, and set properties
  set axi_role_interconnect [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_role_interconnect ]
  set_property -dict [ list \
   CONFIG.NUM_MI {1} \
   CONFIG.NUM_SI {4} \
 ] $axi_role_interconnect
  ...
  # Create instance: concat_axi_ic_ddr_mem_S00_AXI_araddr, and set properties
  set concat_axi_ic_ddr_mem_S00_AXI_araddr [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat_axi_ic_ddr_mem_S00_AXI_araddr ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {3} \
 ] $concat_axi_ic_ddr_mem_S00_AXI_araddr

  # Create instance: concat_axi_ic_ddr_mem_S00_AXI_awaddr, and set properties
  set concat_axi_ic_ddr_mem_S00_AXI_awaddr [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 concat_axi_ic_ddr_mem_S00_AXI_awaddr ]
  set_property -dict [ list \
   CONFIG.NUM_PORTS {3} \
 ] $concat_axi_ic_ddr_mem_S00_AXI_awaddr
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins axi_dma_0/M_AXI_MM2S] [get_bd_intf_pins axi_role_interconnect/S02_AXI]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins axi_role_interconnect/S03_AXI]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_SG [get_bd_intf_pins axi_dma_0/M_AXI_SG] [get_bd_intf_pins axi_role_interconnect/S01_AXI]
  connect_bd_intf_net -intf_net axi_dwidth_converter_0_M_AXI [get_bd_intf_pins axi_dwidth_converter_0/M_AXI] [get_bd_intf_pins u_role/s_axi_dma]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dwidth_converter_0_M_AXI] [get_bd_intf_pins axi_dwidth_converter_0/M_AXI] [get_bd_intf_pins system_ila/SLOT_3_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_ic_ep_bar_axi_lite_M01_AXI] [get_bd_intf_pins axi_ic_ep_bar_axi_lite/M01_AXI] [get_bd_intf_pins system_ila/SLOT_2_AXI]
  connect_bd_intf_net -intf_net axi_ic_ep_bar_axi_lite_M03_AXI [get_bd_intf_pins axi_ic_ep_bar_axi_lite/M03_AXI] [get_bd_intf_pins axi_mm_base_reg/S_AXI]
  connect_bd_intf_net -intf_net axi_ic_pcie_rp_dma_M00_AXI [get_bd_intf_pins axi_ic_pcie_rp_dma/M00_AXI] [get_bd_intf_pins axi_role_interconnect/S00_AXI]
  connect_bd_intf_net -intf_net axi_ic_pcie_rp_mmio_M00_AXI [get_bd_intf_pins axi_ic_pcie_rp_mmio/M00_AXI] [get_bd_intf_pins xdma_rp/S_AXI_B]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_ic_pcie_rp_mmio_M00_AXI] [get_bd_intf_pins axi_ic_pcie_rp_mmio/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_ic_pcie_rp_mmio_M01_AXI] [get_bd_intf_pins axi_ic_pcie_rp_mmio/M01_AXI] [get_bd_intf_pins system_ila_0/SLOT_2_AXI]
  ...
  connect_bd_intf_net -intf_net axi_role_interconnect_M00_AXI [get_bd_intf_pins axi_dwidth_converter_0/S_AXI] [get_bd_intf_pins axi_role_interconnect/M00_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets u_role_m_axi_mem] [get_bd_intf_pins axi_ic_ddr_mem/S01_AXI] [get_bd_intf_pins system_ila/SLOT_0_AXI]
  connect_bd_intf_net -intf_net u_role_m_axis_trace [get_bd_intf_pins u_role/m_axis_trace] [get_bd_intf_pins xdma_ep/S_AXIS_C2H_0]
  connect_bd_intf_net -intf_net xdma_ep_M_AXI_BYPASS [get_bd_intf_pins axi_ic_ddr_mem/S00_AXI] [get_bd_intf_pins xdma_ep/M_AXI_BYPASS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets xdma_rp_M_AXI_B] [get_bd_intf_pins system_ila_0/SLOT_0_AXI] [get_bd_intf_pins xdma_rp/M_AXI_B]
  ...
  connect_bd_net -net axi_mm_base_reg_gpio_io_o [get_bd_pins axi_mm_base_reg/gpio_io_o] [get_bd_pins concat_axi_ic_ddr_mem_S00_AXI_araddr/In1] [get_bd_pins concat_axi_ic_ddr_mem_S00_AXI_awaddr/In1]
  connect_bd_net -net concat_axi_ic_ddr_mem_S00_AXI_araddr_dout [get_bd_pins axi_ic_ddr_mem/S00_AXI_araddr] [get_bd_pins concat_axi_ic_ddr_mem_S00_AXI_araddr/dout]
  connect_bd_net -net concat_axi_ic_ddr_mem_S00_AXI_awaddr_dout [get_bd_pins axi_ic_ddr_mem/S00_AXI_awaddr] [get_bd_pins concat_axi_ic_ddr_mem_S00_AXI_awaddr/dout]
  connect_bd_net -net const_28b0_dout [get_bd_pins concat_axi_ic_ddr_mem_S00_AXI_araddr/In2] [get_bd_pins concat_axi_ic_ddr_mem_S00_AXI_awaddr/In2] [get_bd_pins const_28b0/dout]
  ...
  connect_bd_net -net const_vcc_dout [get_bd_pins const_vcc/dout] [get_bd_pins ddr4_mig_sync_reset/dcm_locked] [get_bd_pins pcie_rp_role_sync_reset/dcm_locked] [get_bd_pins xdma_ep/m_axis_h2c_tready_0]
  ...
  connect_bd_net -net slice_xdma_ep_m_axib_araddr_Dout [get_bd_pins concat_axi_ic_ddr_mem_S00_AXI_araddr/In0] [get_bd_pins slice_xdma_ep_m_axib_araddr/Dout]
  connect_bd_net -net slice_xdma_ep_m_axib_awaddr_Dout [get_bd_pins concat_axi_ic_ddr_mem_S00_AXI_awaddr/In0] [get_bd_pins slice_xdma_ep_m_axib_awaddr/Dout]
  connect_bd_net -net xdma_ep_axi_aclk [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dwidth_converter_0/s_axi_aclk] [get_bd_pins axi_ethernet_0/axis_clk] [get_bd_pins axi_ethernet_0/s_axi_lite_clk] [get_bd_pins axi_ic_bootrom/ACLK] [get_bd_pins axi_ic_bootrom/M00_ACLK] [get_bd_pins axi_ic_bootrom/S00_ACLK] [get_bd_pins axi_ic_bootrom/S01_ACLK] [get_bd_pins axi_ic_ddr_mem/ACLK] [get_bd_pins axi_ic_ddr_mem/S00_ACLK] [get_bd_pins axi_ic_ddr_mem/S01_ACLK] [get_bd_pins axi_ic_ep_bar_axi_lite/ACLK] [get_bd_pins axi_ic_ep_bar_axi_lite/M00_ACLK] [get_bd_pins axi_ic_ep_bar_axi_lite/M01_ACLK] [get_bd_pins axi_ic_ep_bar_axi_lite/M02_ACLK] [get_bd_pins axi_ic_ep_bar_axi_lite/M03_ACLK] [get_bd_pins axi_ic_ep_bar_axi_lite/S00_ACLK] [get_bd_pins axi_ic_pcie_rp_dma/ACLK] [get_bd_pins axi_ic_pcie_rp_dma/M00_ACLK] [get_bd_pins axi_ic_pcie_rp_mmio/ACLK] [get_bd_pins axi_ic_pcie_rp_mmio/S00_ACLK] [get_bd_pins axi_ic_role_io/ACLK] [get_bd_pins axi_ic_role_io/M00_ACLK] [get_bd_pins axi_ic_role_io/M01_ACLK] [get_bd_pins axi_ic_role_io/M02_ACLK] [get_bd_pins axi_ic_role_io/M03_ACLK] [get_bd_pins axi_ic_role_io/M04_ACLK] [get_bd_pins axi_ic_role_io/S00_ACLK] [get_bd_pins axi_mm_base_reg/s_axi_aclk] [get_bd_pins axi_role_interconnect/ACLK] [get_bd_pins axi_role_interconnect/M00_ACLK] [get_bd_pins axi_role_interconnect/S00_ACLK] [get_bd_pins axi_role_interconnect/S01_ACLK] [get_bd_pins axi_role_interconnect/S02_ACLK] [get_bd_pins axi_role_interconnect/S03_ACLK] [get_bd_pins bootrom_bram_ctrl/s_axi_aclk] [get_bd_pins host_uart/s_axi_aclk] [get_bd_pins led_counter/CLK] [get_bd_pins pcie_rp_role_sync_reset/slowest_sync_clk] [get_bd_pins role_uart/s_axi_aclk] [get_bd_pins system_ila/clk] [get_bd_pins u_role/aclk] [get_bd_pins xdma_ep/axi_aclk]
  connect_bd_net -net xdma_ep_axi_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dwidth_converter_0/s_axi_aresetn] [get_bd_pins axi_ethernet_0/s_axi_lite_resetn] [get_bd_pins axi_ic_bootrom/ARESETN] [get_bd_pins axi_ic_bootrom/M00_ARESETN] [get_bd_pins axi_ic_bootrom/S00_ARESETN] [get_bd_pins axi_ic_bootrom/S01_ARESETN] [get_bd_pins axi_ic_ddr_mem/ARESETN] [get_bd_pins axi_ic_ddr_mem/S00_ARESETN] [get_bd_pins axi_ic_ddr_mem/S01_ARESETN] [get_bd_pins axi_ic_ep_bar_axi_lite/ARESETN] [get_bd_pins axi_ic_ep_bar_axi_lite/M00_ARESETN] [get_bd_pins axi_ic_ep_bar_axi_lite/M01_ARESETN] [get_bd_pins axi_ic_ep_bar_axi_lite/M02_ARESETN] [get_bd_pins axi_ic_ep_bar_axi_lite/M03_ARESETN] [get_bd_pins axi_ic_ep_bar_axi_lite/S00_ARESETN] [get_bd_pins axi_ic_role_io/ARESETN] [get_bd_pins axi_ic_role_io/M00_ARESETN] [get_bd_pins axi_ic_role_io/M01_ARESETN] [get_bd_pins axi_ic_role_io/M03_ARESETN] [get_bd_pins axi_ic_role_io/M04_ARESETN] [get_bd_pins axi_ic_role_io/S00_ARESETN] [get_bd_pins axi_mm_base_reg/s_axi_aresetn] [get_bd_pins axi_role_interconnect/ARESETN] [get_bd_pins axi_role_interconnect/M00_ARESETN] [get_bd_pins axi_role_interconnect/S00_ARESETN] [get_bd_pins axi_role_interconnect/S01_ARESETN] [get_bd_pins axi_role_interconnect/S02_ARESETN] [get_bd_pins axi_role_interconnect/S03_ARESETN] [get_bd_pins bootrom_bram_ctrl/s_axi_aresetn] [get_bd_pins host_uart/s_axi_aresetn] [get_bd_pins role_uart/s_axi_aresetn] [get_bd_pins system_ila/resetn] [get_bd_pins u_role/aresetn] [get_bd_pins xdma_ep/axi_aresetn]
  ...
  connect_bd_net -net xdma_rp_axi_aclk [get_bd_pins axi_ic_pcie_rp_dma/S00_ACLK] [get_bd_pins axi_ic_pcie_rp_mmio/M00_ACLK] [get_bd_pins axi_ic_pcie_rp_mmio/M01_ACLK] [get_bd_pins system_ila_0/clk] [get_bd_pins xdma_rp/axi_aclk]
  connect_bd_net -net xdma_rp_axi_aresetn [get_bd_pins axi_ic_pcie_rp_dma/S00_ARESETN] [get_bd_pins axi_ic_pcie_rp_mmio/M00_ARESETN] [get_bd_pins system_ila_0/resetn] [get_bd_pins xdma_rp/axi_aresetn]
  ...
  assign_bd_address -offset 0x00000000 -range 0x00010000000000000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_SG] [get_bd_addr_segs u_role/s_axi_dma/reg0] -force
  assign_bd_address -offset 0x00000000 -range 0x00010000000000000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs u_role/s_axi_dma/reg0] -force
  assign_bd_address -offset 0x00000000 -range 0x00010000000000000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs u_role/s_axi_dma/reg0] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces xdma_ep/M_AXI_BYPASS] [get_bd_addr_segs ddr4_mig/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
  ...
  assign_bd_address -offset 0x80000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces xdma_rp/M_AXI_B] [get_bd_addr_segs u_role/s_axi_dma/reg0] -force
