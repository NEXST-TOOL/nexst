# #========================================================
# # Top-level constraint file for Xiangshan on AU280
# # Based on Vivado 2020.2
# # Author: Yazhou Wang (wangyazhou@ict.ac.cn)
# # Date: 11/01/2025
# #========================================================
...
set_property PACKAGE_PIN BJ43 [get_ports ddr4_mig_sys_clk_clk_p]
set_property PACKAGE_PIN BJ44 [get_ports ddr4_mig_sys_clk_clk_n]

# PCIe EP perstn physical location
set_property PACKAGE_PIN BH26 [get_ports pcie_ep_perstn]
set_property IOSTANDARD LVCMOS18 [get_ports pcie_ep_perstn]

set_property KEEP TRUE [get_pins role_intr_concat/dout]
